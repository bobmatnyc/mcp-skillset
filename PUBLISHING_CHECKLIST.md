# PyPI Publishing Checklist - mcp-skills v0.1.0
...
- [x] **pyproject.toml** - Updated with real GitHub URLs (bobmatnyc/mcp-skills)
...
# Go to: https://github.com/bobmatnyc/mcp-skills/releases/new
# - Tag: v0.1.0
...
- **Repository**: https://github.com/bobmatnyc/mcp-skills.git
- **Issues**: https://github.com/bobmatnyc/mcp-skills/issues
- **License**: MIT
